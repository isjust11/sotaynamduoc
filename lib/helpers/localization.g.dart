...
class Localization extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'fr': {
      ...
      'auth.usernameFormField': 'Nom d\'utilisateur',
    ...
    'es': {
      ...
      'auth.usernameFormField': 'Nombre de usuario',
    ...
    'de': {
      ...
      'auth.usernameFormField': 'Benutzername',
      'auth.emailFormField': 'Email',
    ...
    'hi': {
      ...
      'auth.usernameFormField': 'उपयोगकर्ता नाम',
      ...
      'auth.updateUserEmailInUse':
          'यही कारण है कि ईमेल पता पहले से ही खाता है।',
    ...
    'pt': {
      ...
      'auth.usernameFormField': 'Nome de usuário',
      'auth.emailFormField': 'E-mail',
    ...
    'ru': {
      ...
      'auth.usernameFormField': 'Имя пользователя',
    ...
    'vi': {
      ...
      'auth.usernameFormField': 'Tên đăng nhập',
      'auth.emailFormField': 'Email',
      'auth.passwordFormField': 'Mật khẩu',
      'auth.nameFormField': 'Tên',
      'auth.signInErrorTitle': 'Lỗi đăng nhập',
      'auth.signInError': 'Đăng nhập thất bại: email hoặc mật khẩu không đúng.',
      'auth.resetPasswordLabelButton': 'Quên mật khẩu?',
      'auth.signUpLabelButton': 'Tạo tài khoản',
      'auth.signUpErrorTitle': 'Đăng ký thất bại.',
      'auth.signUpError': 'Có lỗi xảy ra khi đăng ký. Vui lòng thử lại sau.',
      'auth.signInLabelButton': 'Có tài khoản? Đăng nhập.',
      'auth.resetPasswordNoticeTitle': 'Mật khẩu đã được gửi',
      'auth.resetPasswordNotice': 'Kiểm tra email của bạn và làm theo hướng dẫn để đặt lại mật khẩu.',
      'auth.resetPasswordFailed': 'Gửi lại mật khẩu thất bại',
      'auth.signInonResetPasswordLabelButton': 'Đăng nhập',
      'auth.updateUser': 'Cập nhật hồ sơ',
      'auth.updateUserSuccessNoticeTitle': 'Cập nhật hồ sơ thành công',
      'auth.updateUserSuccessNotice': 'Thông tin hồ sơ đã được cập nhật thành công.',
      'auth.updateUserEmailInUse': 'Email này đã có tài khoản.',
      'auth.updateUserFailNotice': 'Cập nhật hồ sơ thất bại',
      ...
      'auth.wrongPasswordNotice': 'Mật khẩu không khớp với dữ liệu của chúng tôi.',
      ...
      'home.emailLabel': 'Email',
      'home.adminUserLabel': 'Admin User',
      'app.title': 'Dự án Flutter Starter',
      'validator.email': 'Vui lòng nhập địa chỉ email hợp lệ.', 
      'validator.password': 'Mật khẩu phải có ít nhất 6 ký tự.',
      'validator.name': 'Vui lòng nhập tên.',
      'validator.number': 'Vui lòng nhập số.',
      'validator.notEmpty': 'Đây là trường bắt buộc.',
      'validator.amount': 'Vui lòng nhập số 250 - tức là không có dấu đô la và không có cent',
