...
class NewsDetailBlocScreen extends StatelessWidget {
  final String newsId;

  const NewsDetailBlocScreen({super.key, required this.newsId});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<NewsBloc>()..add(LoadNewsDetail(newsId)),
      child: const NewsDetailBlocView(),
    );
  }
}

class NewsDetailBlocView extends StatelessWidget {
  const NewsDetailBlocView({super.key});
